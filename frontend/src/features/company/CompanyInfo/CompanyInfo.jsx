...
const CompanyInfo = ({ companyInfo, jobId }) => {
  ...
  return (
    <div className="education-form-card" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      {/* Make the main content flexible so the card can stretch to match sibling height */}
