...
class ProfilePictureUploadTests(APITestCase):
    ...
    def test_upload_valid_image(self, mock_process):
        ...
        # process_profile_picture returns (file, error_msg) tuple
        from django.core.files.base import ContentFile
        mock_file = ContentFile(b'fake image data', name='test.jpg')
        mock_process.return_value = (mock_file, None)
    ...
    def test_delete_picture_when_none_exists(self):
        ...
        # API returns 404 when no picture exists (which is correct behavior)
