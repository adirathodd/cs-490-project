    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relationship_type', models.CharField(blank=True, max_length=80)),
                ('relationship_strength', models.IntegerField(default=0)),
                ('last_interaction', models.DateTimeField(blank=True, null=True)),
                ('external_id', models.CharField(blank=True, max_length=255, db_index=True)),
            ...
            options={
                'indexes': [models.Index(fields=['owner', 'external_id'], name='idx_core_contact_owner_external_id'), models.Index(fields=['owner', 'updated_at'], name='idx_core_contact_owner_updated_at')],
            },
        ),
        migrations.CreateModel(
            name='Document',
        ...
        migrations.AddIndex(
            model_name='contact',
            index=models.Index(fields=['owner', '-last_interaction'], name='core_contac_owner_lastint_3f1e2d_idx'),
        ),
        migrations.AddIndex(
            model_name='contact',
        ...
        migrations.AddIndex(
            model_name='reminder',
            index=models.Index(fields=['contact', 'completed', 'due_date'], name='core_remind_candida_82df9a_idx'),
        ),
        # Removed invalid reminder.application index (Reminder model has no 'application' field)
        migrations.AddIndex(
